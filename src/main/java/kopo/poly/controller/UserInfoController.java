...
public class UserInfoController {
    ...
    public String insertUserInfo(HttpServletRequest request, ModelMap modelMap) throws Exception {
        ...
        try {
             ...
             *
             * 무조건 웹으로 받은 정보는 pDTO에 저장하기 위해 임시로 String 변수에 저장함
             * ########################################################
             */
    ...
    public String noticeList(){
        log.info(this.getClass().getName() + ".notice/noticeList Start!");
        log.info(this.getClass().getName() + ".notice/noticeList End!");
